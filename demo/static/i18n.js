...
(function () {
  const DICT = {
    en: {
      ...
      cta_get_started: "Get started", cta_try_live: "Try it live", copy: "copy",
    ...
    es: {
      ...
      cta_get_started: "Empieza", cta_try_live: "Pruébalo en vivo", copy: "copiar",
    ...
    pt: {
      ...
      cta_get_started: "Começar", cta_try_live: "Teste ao vivo", copy: "copiar",
